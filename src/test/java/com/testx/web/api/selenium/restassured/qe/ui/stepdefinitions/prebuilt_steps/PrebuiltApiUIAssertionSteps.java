...
//
    ...
    public void iVerifyUIDataToAPIData(String api, String pageName,DataTable usertable) throws Exception {
        ...
        String responsepath = FileUtil.readFileAsString(API_RESPONSE_PATH + api + ".json");
